table 99029 "PTE App. Metadata Set Object"
{
    Caption = 'Application Metadata Set Objects';
    DrillDownPageID = "PTE App. Metadata Set Objects";
    LookupPageID = "PTE App. Metadata Set Objects";
    fields
    {
        ...
        field(3; "Object Type"; Enum "PTE Object Type")
        {
            Caption = 'Object Type';
            DataClassification = ToBeClassified;
        }
