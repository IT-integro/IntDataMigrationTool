page 99032 "ITI App. Metadata Set List"
{
    ApplicationArea = All;
    Caption = 'Application Metadata Set List';
    PageType = List;
    SourceTable = "ITI App. Metadata Set";
    ...
    actions
    {
        area(creation)
        {
            ...
            action("Objects")
            {
                ...
                PromotedCategory = Process;
                PromotedIsBig = true;
                RunObject = Page "ITI App. Metadata Set Objects";
        ...
        area(Navigation)
        {
            action("Get Export CU for NAV 2009")
            {
                ...
                trigger OnAction()
                var
                    GetExportCodeunitFile: Codeunit "ITI Get Export Codeunit File";
                begin
