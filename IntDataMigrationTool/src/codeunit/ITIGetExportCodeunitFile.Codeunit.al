codeunit 99009 "ITI Get Export Codeunit File"
{
    ...
    begin
        ...
        CodeunitText.AddText('        Version List=ITI Migration Tool;' + NewLine);
        CodeunitText.AddText('  }' + NewLine);
        ...
        CodeunitText.AddText('            //This codeunit exports metadata of NAV 2009 table objects for ITI Migration Tool.' + NewLine);
