table 99025 "ITI Migr. Dataset Error"
{
    Caption = 'ITI Migr. Dataset Errors';
    DrillDownPageId = "ITI Migr. Dataset Errors";
    LookupPageId = "ITI Migr. Dataset Errors";
    ...
    fields
    {
        ...
        field(20; "Error Type"; Enum "ITI Dataset Error Types")
        {
            DataClassification = ToBeClassified;
            Caption = 'Error Type';
        }
