table 99014 "ITI App. Object Table Field"
{
    Caption = 'Application Object Table Field';
    DrillDownPageID = "ITI App. Object Table Fields";
    LookupPageID = "ITI App. Object Table Fields";
    fields
    {
        ...
        {
            Caption = 'Table ID';
            TableRelation = "ITI App. Object Table"."ID" where("SQL Database Code" = field("SQL Database Code"));
            ValidateTableRelation = true;
            DataClassification = ToBeClassified;
        }
        field(3; "ID"; Integer)
        ...
        {
            Caption = 'Table Name';
            TableRelation = "ITI App. Object Table"."Name" where("SQL Database Code" = field("SQL Database Code"), "ID" = field("Table ID"));
            Editable = false;
            ValidateTableRelation = true;
        }
        ...
        field(40; "App ID"; Text[40])
        {
            Caption = 'App ID';
            DataClassification = ToBeClassified;
            TableRelation = "ITI SQL Database Installed App"."ID" WHERE("SQL Database Code" = FIELD("SQL Database Code"));
        }
        field(45; "App Name"; Text[250])
        {
            Caption = 'App Name';
            FieldClass = FlowField;
            CalcFormula = Lookup("ITI SQL Database Installed App".Name WHERE("SQL Database Code" = FIELD("SQL Database Code"), "ID" = field("App ID")));
    ...
    begin
        ...
        ITIAppObjectTblFieldOpt.SetRange("Table ID", "Table ID");
        ITIAppObjectTblFieldOpt.SetRange("Field ID", ID);
    ...
    begin
        ITIAppObjectTable.Get("SQL Database Code", "Table ID");
        ITISQLDatabaseCompany.Get("SQL Database Code", CompanyName);
        if ITIAppObjectTable.DataPerCompany then
            exit(ITISQLDatabaseCompany."SQL Name" + '$' + "SQL Table Name Excl. C. Name")
        else
