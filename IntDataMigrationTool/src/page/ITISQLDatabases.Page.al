    ...
    actions
    {
        ...
        area(Navigation)
        {
            action("SQL Tables")
            {
                ...
                ApplicationArea = All;
                Image = "Table";
                RunObject = Page "ITI SQL Database Tables";
            ...
            action("Installed Apps")
            {
                ...
                RunObject = Page "ITI SQL Database InstalledApps";
                RunPageLink = "SQL Database Code" = field("Code");
                RunPageMode = View;
            }
            action("Application Objects")
            {
                ...
                RunObject = Page "ITI App. Objects";
                RunPageLink = "SQL Database Code" = field("Code");
            }
            action("Application Object Tables")
            {
                ...
                ApplicationArea = All;
                Image = ExtendedDataEntry;
                RunObject = Page "ITI App. Object Tables";
                RunPageLink = "SQL Database Code" = field("Code");
            }
            action("Application Object Enums")
            {
                ...
                ApplicationArea = All;
                Image = ExtendedDataEntry;
                RunObject = Page "ITI App. Object Enums";
                RunPageLink = "SQL Database Code" = field("Code");
            }
            action("Database Companies")
            {
                ...
                ApplicationArea = All;
                Image = ExtendedDataEntry;
                RunObject = Page "ITI SQL Database COmpanies";
                RunPageLink = "SQL Database Code" = field("Code");
            }
        }
    }
