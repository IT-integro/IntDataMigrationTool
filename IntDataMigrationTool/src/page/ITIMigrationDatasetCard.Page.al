page 99013 "ITI Migration Dataset Card"
{
    ApplicationArea = All;
    Caption = 'Migration Dataset Card';
    PageType = Document;
    SourceTable = "ITI Migration Dataset";
    UsageCategory = None;
    ...
    layout
    {
        area(content)
        {
            ...
            part(MigrationDatasetTables; "ITI Migration Dataset Subform")
            {
                ApplicationArea = All;
        ...
        area(Processing)
        {
            ...
            group("Mapping")
            {
                ...
                action("Create Mapping from Dataset")
                {
                    ...
                    trigger OnAction()
                    var
                        ITICopyMappingFromDataset: Codeunit "ITI Copy Mapping From Dataset";
                    begin
                        ITICopyMappingFromDataset.Run(Rec);
                    end;
                }
            }
            action("Release")
