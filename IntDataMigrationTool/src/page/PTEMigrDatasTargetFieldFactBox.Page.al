page 99041 "PTEMigrDatasTargetFieldFactBox"
{
    ApplicationArea = All;
    Caption = 'Target field additional info.';
    PageType = CardPart;
    SourceTable = "PTE App. Object Table Field";
    ...
    layout
    {
        area(content)
        {
            ...
            {
                ToolTip = 'Specifies the fields application ID.';
                ApplicationArea = All;
            }
            field("App Name"; Rec."App Name")
            {
                ToolTip = 'Specifies the fields application name.';
                ApplicationArea = All;
            }
